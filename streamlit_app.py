...
def run_image_analysis(image):
    # SAFETY FIX 1: Resize to 1024x1024 (Model's native size)
    # This prevents RAM crashes with large phone photos AND improves accuracy
...
def get_prediction_image(mask):
    ...
    # ACCURACY FIX 2: Remove "salt and pepper" noise
    # Uses PIL (Lightweight) instead of Scipy (Heavy) to prevent crashes
